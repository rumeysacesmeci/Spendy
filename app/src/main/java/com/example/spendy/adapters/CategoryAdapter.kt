...
class CategoryAdapter(private val context: Context,private val categoryList:List<Categories>,
    ...
    inner class CategoryCardViewHolder(view:View):RecyclerView.ViewHolder(view),View.OnClickListener{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CategoryCardViewHolder {
        val design = LayoutInflater.from(context).inflate(R.layout.card_view_category,parent,false)
